"""
Django settings for BHDigitalCollection project.
...
ROOT_URLCONF = 'bhdigitalcollection.urls'
...
WSGI_APPLICATION = 'bhdigitalcollection.wsgi.application'
...
LOCALE_PATHS = (
    os.path.join(BASE_DIR, 'bhdigitalcollection', 'locale'),
)
